  ...
  return (
    <div className="bg-grey-10 p-1 tablet:bg-transparent tablet:p-0 rounded-md border border-grey-50 tablet:border-none">
      <select
        ...
        className="text-xs text-grey-500 hover:text-grey-600 p-1 focus:outline-2 focus:outline-offset-1 focus:outline-blue-500 focus:text-grey-600 bg-transparent border-0 cursor-pointer appearance-none min-w-[8ch] w-auto"
