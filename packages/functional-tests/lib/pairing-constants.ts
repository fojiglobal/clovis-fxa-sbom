...
export const SELECTORS = {
  ...
  // /pair index choice screen
  PAIR_CHOICE_HEADER: ['#pair-header'],
  PAIR_RADIO_HAS_MOBILE: ['#has-mobile'],
  PAIR_RADIO_NEEDS_MOBILE: ['#needs-mobile'],
  PAIR_CONTINUE_BUTTON: ['#set-needs-mobile'],
} as const;
